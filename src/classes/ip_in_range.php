...
class ip_in_range {
    ...
    */
     ...
     * Network ranges can be specifiad as:
     * 1. Wildcard format:      1.2.3.*
     * 2. CIDR format:          1.2.3/14 OR 1.2.3.4/255.255.255.0
     * 3. Start-End IP format:  1.2.3.0 - 1.2.3.255
     * 
    ...
    public function ip_in_range($ip, $range) {
        if(strpos($range, '/') !== false) {
            ...
            if(strpos($netmask, '.') !== false) {
                // $netmask is a 255.255.255.0 format.
                ...
                # Strategy 1 - Create the netmask with 'netmask' ones and then fill it to 32 with zeros.
